...
<head>
  ...
  <title>WebGIS Sanggar Seni Lokal</title>
...
<body>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#location">Peta</a></li>
            <li><a href="#data">Data Sanggar Seni</a></li>
            <li class="drop-down"><a href="admin/login.html">Login</a>
              <ul>
                <li><a href="admin/pages/login/login.php">Login</a></li>
                <li><a href="admin/pages/login/register.php">Register</a></li>
              </ul>
            </li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Pemetaan Sanggar Seni</h1>
      <h2>Di Kota Tasikmalaya</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>WebGIS Pemetaan Sanggar Seni di Kota Tasikmlaya</h2>
            <h3>Sistem informasi ini merupakan aplikasi berbasis website Pemetaan Sanggar Seni di wilayah Kota Tasikmalaya. Aplikasi ini memuat informasi dan lokasi Sanggar Seni di Kota Tasikmalaya.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Dalam aplikasi pemetaan geografis ini memuat informasi dan lokasi dari seluruh Sanggar Seni di Kota Tasikmalaya. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing - masing Sanggar Seni. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Sanggar Seni yang ada di Kota Tasikmalaya</li>
            </ul>
            <p class="font-italic">
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>WebGIS</h3>
          <p> Detail Sanggar Seni di Kota Tasikmalaya</p>
          <a class="cta-btn" href="#data">Lihat Detail</a>
        </div>
      ...
      <div class="container">
        ...
        <div class="panel-body" style="align-content: center;">
          <div id="map" style="width:100%;height:480px;"></div>
            <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyAZt1dAd6-IRfXSSiAwKcFFDJal7qeE19A"></script>
              ...
              <script type="text/javascript">
                function initialize() {
                  ...
                  var mapOptions = {   
                      zoom: 13,
                      center: new google.maps.LatLng(-7.3483159, 108.2173686018092), 
              ...
              ?>
              [<?php echo $item->id ?>,'<?php echo $item->nama_senbud ?>','<?php echo $item->alamat ?>', <?php echo $item->longitude ?>, <?php echo $item->latitude ?>],
              <?php 
              }
              } 
              ?>    
        ...
        <!-- ======= Contact Section ======= -->
    <section id="data" class="contact">
      <div class="container">
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data Sanggar Seni</h2>
              <p>Halaman ini memuat informasi Sanggar Seni di Kota Tasikmalaya. </p>
            </div>
          </div>
          ...
          <div class="panel panel-info panel-dashboard">
            <div class="panel-heading centered">
              <h2 class="panel-title"><strong> - <?php echo 'Informasi' ?> - </strong></h2>
            </div>
            <div class="table-responsive">
              ...
              <thead>
                <tr class="align-middle">
                  <th scope="col">No.</th>
                  <th scope="col">Nama Sanggar Seni</th>
              ...
              <tr>
                <td><?php echo $no; ?></td>
                <td><?php echo $item->nama_senbud; ?></td>
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info mt-4">
              ...
              <h4>Lokasi:</h4>
              <p>Jl. Peta No. 177, Kahuripan, Kec. Tawang, Kota Tasikmalaya, Jawa Barat, Indonesia</p>
            </div>
            <div class="row">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Data</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Sanggar Seni</a></li>
            </ul>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>WebGIS Sanggar Seni</span></strong>.
        </div>
      </div>
