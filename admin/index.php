...
if (!isset($_SESSION["login"])) {
  header("Location: /sig/admin/pages/login/login.php");
  exit;
}
...
<head>
  ...
  <title>Admin | WebGIS Seni Budaya Kota Tasikmalaya</title>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <input type="hidden" name="id" value="<?= $user["id"]; ?>">
          <a href="#" class="d-block"><?= $user["id"] ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/data/senbud.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/data/pameran.php" class="nav-link">
